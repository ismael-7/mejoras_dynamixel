...
os.sys.path.append('/home/odroid/software/DynamixelSDK-3.4.3/python/dynamixel_functions_py')  # Path setting
...
class SpecificWorker(GenericWorker):
    ...
    def setParams(self, params):
        ...
        self.serial_port_number = dynamixel.portHandler(self.serial_port_name)
        ...
        if not dynamixel.openPort(self.serial_port_number):
            ...
            print('el puerto transmite a ' + str(dynamixel.getBaudRate(self.serial_port_number)) + ' baudios')
